...
### Tracing de 3 execuções

[Precision](https://smith.langchain.com/public/1e7d44a1-3f45-41d8-814f-285b26609624/r)

[Clarity](https://smith.langchain.com/public/0eb316ed-33ec-4a7b-b1f1-889b05cc3df6/r)

[F1_score](https://smith.langchain.com/public/7a058e4b-2eb7-4af3-82a3-c201d2262516/r)
...
1. **Pull do Prompt Base:** Baixe o prompt `leonardofraga/bug_to_user_story_v2` do LangSmith:
   ```bash
   python src/pull_prompts.py
   ```

2. **Validação dos Testes:** Execute os testes:
   ```bash
   pytest tests/test_prompts.py
   ```

3. **Avaliação:** Execute a bateria de testes de IA e confira as métricas:
   ```bash
